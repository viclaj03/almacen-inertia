            ...
            <div class="grid grid-cols-2 gap-6   max-w-7xl mx-auto sm:px-6 lg:px-12 ">
                <div>
                    <Form :validation-schema="mySchema" @submit="submitForm"
                        class="  w-full max-w-xl    border-green-400 border-2 rounded-2xl" id="form"
                        :class="{ 'bg-red-600': form.pegi18, 'bg-slate-600': !form.pegi18 }">
                        <div class="mb-4 p-5">
                            <label for="name"
                        ...
                        <div class="mb-4 p-5">
                            ...
                            <Field name="danbooru_url" v-model="form.danbooru_url" type="url" id="url_danbooru"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="URL" />
                            <div v-if="form.errors.danbooru_url" class="text-green-500 text-xs italic uppercase"
                                v-html="form.errors.danbooru_url"></div>
                        ...
                        <div class="mb-4 p-5">
                            ...
                            <label for="disabled-checkbox"
                                class="pr-10 ml-1 text-sm font-medium text-white">NSFW</label>

                            <input type="checkbox" v-model="form.private"
                                class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="disabled-checkbox" 
                                class="pr-10 ml-1 text-sm font-medium text-white">Private</label>
                            
                            <input v-if="!image"  type="checkbox" v-model="form.favorite"
                                class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="disabled-checkbox" 
                                class=" ml-1 text-sm font-medium text-white">Favorite</label>
                        </div>

                        <div>
                            <v-select class=" " multiple v-model="form.tags" @search="onSearch" label="label"
                                :options="searchResults" placeholder="Etiquetas">
                            </v-select>
                        ...
                        <div v-if="!image" class="mb-4 p-5">
                            ...
                            <div v-if="form.errors.image">
                                <input type="checkbox" v-model="form.hash_ignore"
                                    class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="disabled-checkbox" class=" ml-2 text-sm font-medium text-white">Ignorar hash
                                </label>
                            </div>
                        ...
                        <div class="mb-4 " style="display: none ;">
                            ...
                            <Field name="description_image" v-model="form.description" as="textarea"
                                id="description_image"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="descripción" />
                            <div v-if="form.errors.description" class="text-green-500 text-xs italic uppercase"
                                v-html="form.errors.description"></div>
                            <ErrorMessage name="danbooru_url" class="text-green-500 text-xs italic uppercase" />
                        ...
                        <div v-if="image">
                            <input type="checkbox" v-model="form.getTags"
                                class=" w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                            <label for="disabled-checkbox" class=" ml-2 text-sm font-medium text-white">volver a coger
                                datos</label>
                ...
                <div class="relative">
                    ...
                    <a v-else :href="'/storage/imagesPost/' + image.imagen" data-fancybox="gallery">
                        ...
                        <img v-if="image.light_version_imagen" class=""
                            :src="'/storage/light_versions/' + image.light_version_imagen" alt="image" width="500"
                            height="600" id="imagePreview">
